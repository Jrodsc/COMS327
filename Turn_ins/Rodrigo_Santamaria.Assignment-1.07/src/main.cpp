...
int main(int argc, char * argv[]){
    ...
    */
    ...
    if(argc > 1) 
        file_name = argv[1], read_file(file_name);
    else
        printf("No command line parameter found, therefore, no file was parsed");
    //printf("Insert the name of the file (without the extension file)\n");
